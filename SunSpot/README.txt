...
**svr_svc_training**
This file includes several functions related to the support vector machine procedures. 
It is composed of a function that automatically estimates an appropriate value for the length of the input vector, functions to train and valide the chart and to remove missing values from the input vectors.

**alerts**
This file contains a function that actually applies the monitoring to the series and returns the durations, the predicted sizes and forms of the deviations after each alert. 
Another function is also defined to graphically display the main features of the monitoring procedure. 

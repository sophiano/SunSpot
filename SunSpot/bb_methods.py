...
if __name__ == "__main__":
    ...
    def moving_average(x, wdw, center=True):
        """
        Smooths a panel of series.
        
        This function applies a smoothing process in time by a moving-average
        (MA) filter on a panel of series. 
        ...
        -------
        x_smth : 2D-array
            The smoothed data by the MA filter.
    ...
    data = moving_average(data, wdw=81)

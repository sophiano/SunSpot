...
and the support vector machine on the composite (Nc=Ns+10Ng) smoothed on a year. 
...
#with open('data/data_1981', 'rb') as file: #local
    ...
    Ns = my_depickler.load() #number of spots (Ns)
    Ng = my_depickler.load() #number of sunspot groups (Ng)
...
#smaller range
#bb_length = bbl.block_length_choice(dataIC, 44, 64, 2) #52
bb_length = 54

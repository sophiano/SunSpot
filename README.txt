...
In the notebooks, the monitoring procedure is applied to the long-term error of Ns, Ng and Nc on two different time-scales with detailed explanations. 

**scripts**
The scripts associated to the notebooks are located inside the folder **scripts**.

**svm_models**
The support vector machine classifiers and regressors trained on Nc are also saved into **svm_models**. They are conserved for reproducibility purposes. 

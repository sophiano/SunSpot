...
** This module contains a robust non-parametric quality control procedure, based on the block bootstrap and the CUSUM chart, to monitor a panel of non-normal autocorrelated observations prone to noise and potential missing values. The method also provides predictions of the shapes and the sizes of the deviations encountered using support vector machine classifier and regressor.**
...
The monitoring procedure is applied on these data as examples. 
The files are provided into .zip, .txt and serialized format (pickling).

**docs**
Jupyter notebooks are provided in the folder **docs**. 
...
The notebooks can be used as examples of how to apply the package to real data.

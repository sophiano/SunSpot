...
The files are provided into .zip files. After extraction, the different objects are contained into csv files. The files are also available in a serialized format, which may be opened with the python module 'pickle' with: 
